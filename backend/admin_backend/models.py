...
from sqlalchemy import Column, Integer, String, Time, Boolean, DateTime, Text, Enum, ForeignKey, Index, Float
...
class Invoice(db.Model):
    ...
    student_id = Column(String(50), ForeignKey('student_meals.student_id'), nullable=True)
    student_name = Column(String(100), nullable=False)
    department = Column(String(100), nullable=True)
    grade_section = Column(String(100), nullable=True)
    ...
    forenoon_count = Column(Integer, default=0)
    afternoon_count = Column(Integer, default=0)
    total_meals = Column(Integer, default=0)
    rate_per_meal = Column(Float, default=50.0)
    ...
    status = Column(Enum('pending', 'paid', 'overdue', 'cancelled'), default='pending')
    payment_method = Column(String(50), default='Pending')
